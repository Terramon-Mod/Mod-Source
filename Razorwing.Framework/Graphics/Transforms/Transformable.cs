using System;
using Razorwing.Framework.Lists;
...
namespace Razorwing.Framework.Graphics.Transforms
{
    ...
    public abstract class Transformable : UIElement, ITransformable
    {
        ...
        /// </summary>
        public IReadOnlyList<Transform> Transforms => transformsLazy.IsValueCreated ? (IReadOnlyList<Transform>)transformsLazy.Value : new Transform[] { };
        ...
        {
            TransformDelay = 0;
            updateTransforms(Time.TotalGameTime.TotalMilliseconds);
        }
        ...
        public void AddTransform(Transform transform, ulong? customTransformID = null)
        {
            ...
            if (transform.StartTime < Time.TotalGameTime.TotalMilliseconds || transform.EndTime <= Time.TotalGameTime.TotalMilliseconds)
                updateTransforms(Time.TotalGameTime.TotalMilliseconds);
        }
    }
}
