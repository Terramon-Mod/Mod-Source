...
namespace Razorwing.Framework.Utils
{
    public static class Interpolation
    {
        ...
        public static Color ValueAt(double time, Color startColour, Color endColour, double startTime, double endTime, Easing easing = Easing.None)
        {
        ...
        public static Rectangle ValueAt(double time, Rectangle val1, Rectangle val2, double startTime, double endTime, Easing easing = Easing.None)
        {
            float current = (float)(time - startTime);
            float duration = (float)(endTime - startTime);
            ...
            return new Rectangle(
                (int)(val1.X + t * (val2.X - val1.X)),
                (int)(val1.Y + t * (val2.Y - val1.Y)),
                (int)(val1.Width + t * (val2.Width - val1.Width)),
                (int)(val1.Height + t * (val2.X - val1.Height)));
        }
