...
namespace Razorwing.Framework.Extensions.TypeExtensions
{
    public static class TypeExtensions
    {
        ...
        public static Type GetUnderlyingNullableType(this Type type)
        {
            ...
            // ReSharper disable once ConvertClRazorwingreToMethodGroup (see: https://github.com/dotnet/runtime/issues/33747)
