...
{
    public class Leer : DamageMove
    {
        public override string MoveName => "Leer";
        public override string MoveDescription => "The user gives opposing Pokémon an intimidating leer that lowers the Defense stat.";
