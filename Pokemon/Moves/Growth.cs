...
{
    public class Growth : DamageMove
    {
        public override string MoveName => "Growth";
        public override string MoveDescription => "The user’s body grows all at once, raising the Attack and Sp. Atk stats.";
