...
{
    public class SolarBeam : DamageMove
    {
        public override string MoveName => "Solar Beam";
        public override string MoveDescription => "In this two-turn attack, the user gathers light, then blasts a bundled beam on the next turn.";
