...
{
    public class SkullBash : DamageMove
    {
        public override string MoveName => "Skull Bash";
        public override string MoveDescription => "The user tucks in its head to raise its Defense stat on the first turn, then rams the target on the next turn.";
        public override int Damage => 130;
