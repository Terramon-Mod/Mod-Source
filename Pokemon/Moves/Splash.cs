...
{
    public class Splash : DamageMove
    {
        public override string MoveName => "Splash";
        public override string MoveDescription => "The user just flops and splashes around to no effect at all...";
