...
{
    public class Reflect : DamageMove
    {
        public override string MoveName => "Reflect";
        public override string MoveDescription => "A wondrous wall of light is put up to reduce damage from physical attacks for five turns.";
