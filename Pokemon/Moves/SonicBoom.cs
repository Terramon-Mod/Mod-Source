...
{
    public class SonicBoom : DamageMove
    {
        public override string MoveName => "Sonic Boom";
        public override string MoveDescription => "The target is hit with a destructive shock wave that always inflicts 20 HP damage.";
