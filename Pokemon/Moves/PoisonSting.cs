...
{
    public class PoisonSting : DamageMove
    {
        public override string MoveName => "Poison Sting";
        public override string MoveDescription => "The user stabs the target with a poisonous stinger. This may also poison the target.";
