...
{
    public class DrillPeck : DamageMove
    {
        public override string MoveName => "Drill Peck";
        public override string MoveDescription => "A corkscrewing attack with a sharp beak acting as a drill.";
