...
namespace Terramon.Pokemon.Moves
{
    ...
    {
        public override string MoveName => "Super Fang";
        public override string MoveDescription => "The user chomps hard on the target with its sharp front fangs. This cuts the target’s HP in half.";
