...
{
    public class HornAttack : DamageMove
    {
        public override string MoveName => "Horn Attack";
        public override string MoveDescription => "The target is jabbed with a sharply pointed horn to inflict damage.";
