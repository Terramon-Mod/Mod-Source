...
{
    public class Fissure : DamageMove
    {
        public override string MoveName => "Fissure";
        public override string MoveDescription => "The user opens up a fissure in the ground and drops the target in. The target faints instantly if this attack hits.";
