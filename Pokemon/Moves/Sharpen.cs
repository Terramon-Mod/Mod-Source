...
{
    public class Sharpen : DamageMove
    {
        public override string MoveName => "Sharpen";
        public override string MoveDescription => "The user makes its edges more jagged,  which raises its Attack stat.";
