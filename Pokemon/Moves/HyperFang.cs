...
{
    public class HyperFang : DamageMove
    {
        public override string MoveName => "Hyper Fang";
        public override string MoveDescription => "The user bites hard on the target with its sharp front fangs. This may also make the target flinch.";
