...
{
    public class HyperBeam : DamageMove
    {
        public override string MoveName => "Hyper Beam";
        public override string MoveDescription => "The target is attacked with a powerful beam. The user can’t move on the next turn.";
