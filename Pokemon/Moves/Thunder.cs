...
{
    public class Thunder : DamageMove
    {
        public override string MoveName => "Thunder";
        public override string MoveDescription => "A wicked thunderbolt is dropped on the target to inflict damage. This may also leave the target with paralysis.";
