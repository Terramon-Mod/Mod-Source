...
{
    public class Thrash : DamageMove
    {
        public override string MoveName => "Thrash";
        public override string MoveDescription => "The user rampages and attacks for two to three turns. The user then becomes confused.";
