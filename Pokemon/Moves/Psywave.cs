...
{
    public class Psywave : DamageMove
    {
        public override string MoveName => "Psywave";
        public override string MoveDescription => "The target is attacked with an odd psychic wave. The attack varies in intensity.";
