...
{
    public class Scratch : DamageMove
    {
        public override string MoveName => "Scratch";
        public override string MoveDescription => "Hard, pointed, sharp claws rake the target to inflict damage.";
