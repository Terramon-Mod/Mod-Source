...
{
    public class BoneClub : DamageMove
    {
        public override string MoveName => "Bone Club";
        public override string MoveDescription => "The user clubs the target with a bone. This may also make the target flinch.";
