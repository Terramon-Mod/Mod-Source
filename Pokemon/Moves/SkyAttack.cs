...
{
    public class SkyAttack : DamageMove
    {
        public override string MoveName => "Sky Attack";
        public override string MoveDescription => "A second-turn attack move where critical hits land more easily. This may also make the target flinch.";
