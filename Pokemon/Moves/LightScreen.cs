...
{
    public class LightScreen : DamageMove
    {
        public override string MoveName => "Light Screen";
        public override string MoveDescription => "A wondrous wall of light is put up to reduce damage from special attacks for five turns.";
