...
{
    public class Lick : DamageMove
    {
        public override string MoveName => "Lick";
        public override string MoveDescription => "The target is licked with a long tongue, causing damage. This may also leave the target with paralysis.";
