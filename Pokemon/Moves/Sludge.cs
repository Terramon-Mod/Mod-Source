...
{
    public class Sludge : DamageMove
    {
        public override string MoveName => "Sludge";
        public override string MoveDescription => "Unsanitary sludge is hurled at the target. This may also poison the target.";
