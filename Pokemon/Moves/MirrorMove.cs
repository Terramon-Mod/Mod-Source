...
{
    public class MirrorMove : DamageMove
    {
        public override string MoveName => "Mirror Move";
        public override string MoveDescription => "The user counters the target by mimicking the target’s last move.";
