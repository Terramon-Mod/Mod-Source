...
{
    public class StringShot : DamageMove
    {
        public override string MoveName => "String Shot";
        public override string MoveDescription => "The opposing Pokémon are bound with silk blown from the user’s mouth that harshly lowers the Speed stat.";
