...
{
    public class LowKick : DamageMove
    {
        public override string MoveName => "Low Kick";
        public override string MoveDescription => "A powerful low kick that makes the target fall over. The heavier the target, the greater the move’s power.";
