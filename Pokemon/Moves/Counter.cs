...
namespace Terramon.Pokemon.Moves
{
    ...
    {
        public override string MoveName => "Counter";
        public override string MoveDescription => "A retaliation move that counters any physical attack, inflicting double the damage taken.";
