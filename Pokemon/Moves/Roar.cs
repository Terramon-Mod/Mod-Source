...
{
    public class Roar : DamageMove
    {
        public override string MoveName => "Roar";
        public override string MoveDescription => "The target is scared off, and a different Pokémon is dragged out. In the wild, this ends a battle against a single Pokémon.";
