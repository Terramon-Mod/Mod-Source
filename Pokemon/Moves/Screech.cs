...
{
    public class Screech : DamageMove
    {
        public override string MoveName => "Screech";
        public override string MoveDescription => "An earsplitting screech harshly lowers the target’s Defense stat.";
