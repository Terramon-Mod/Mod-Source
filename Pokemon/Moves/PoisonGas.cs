...
{
    public class PoisonGas : DamageMove
    {
        public override string MoveName => "Poison Gas";
        public override string MoveDescription => "A cloud of poison gas is sprayed in the face of opposing Pokémon, poisoning those hit.";
