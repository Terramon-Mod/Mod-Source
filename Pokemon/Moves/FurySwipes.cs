...
{
    public class FurySwipes : DamageMove
    {
        public override string MoveName => "Fury Swipes";
        public override string MoveDescription => "The target is raked with sharp claws or scythes quickly two to five times in a row.";
