...
{
    public class Conversion : DamageMove
    {
        public override string MoveName => "Conversion";
        public override string MoveDescription => "The user changes its type to become the same type as the move at the top of the list of moves it knows.";
