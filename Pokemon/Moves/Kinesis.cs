...
{
    public class Kinesis : DamageMove
    {
        public override string MoveName => "Kinesis";
        public override string MoveDescription => "The user distracts the target by bending a spoon. This lowers the target’s accuracy.";
