...
{
    public class Struggle : DamageMove
    {
        public override string MoveName => "Struggle";
        public override string MoveDescription => "This attack is used in desperation only if the user has no PP. It also damages the user a little.";
        public override int Damage => 50;
        public override int Accuracy => -1;
        public override int MaxPP => 1;
        public override int MaxBoostPP => 1;
