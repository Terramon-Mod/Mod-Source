...
{
    public class Bubble : DamageMove
    {
        public override string MoveName => "Bubble";
        public override string MoveDescription => "A spray of countless bubbles is jetted at the opposing Pokémon. This may also lower their Speed stat.";
