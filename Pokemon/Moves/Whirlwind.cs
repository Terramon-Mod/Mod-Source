...
{
    public class Whirlwind : DamageMove
    {
        public override string MoveName => "Whirlwind";
        public override string MoveDescription => "The target is blown away, and a different Pokémon is dragged out. In the wild, this ends a battle against a single Pokémon.";
