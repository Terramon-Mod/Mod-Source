...
namespace Terramon.Pokemon.Moves
{
    ...
    {
        public override string MoveName => "Hydro Pump";
        public override string MoveDescription => "The target is blasted by a huge volume of water launched under great pressure.";
