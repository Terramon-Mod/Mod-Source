...
{
    public class Rest : DamageMove
    {
        public override string MoveName => "Rest";
        public override string MoveDescription => "The user goes to sleep for two turns. This fully restores the user’s HP and heals any status conditions.";
