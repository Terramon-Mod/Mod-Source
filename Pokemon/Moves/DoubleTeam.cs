...
{
    public class DoubleTeam : DamageMove
    {
        public override string MoveName => "Double Team";
        public override string MoveDescription => "By moving rapidly, the user makes illusory copies of itself to raise its evasiveness.";
