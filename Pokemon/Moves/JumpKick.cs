...
{
    public class JumpKick : DamageMove
    {
        public override string MoveName => "Jump Kick";
        public override string MoveDescription => "The user jumps up high, then strikes with a kick. If the kick misses, the user hurts itself.";
