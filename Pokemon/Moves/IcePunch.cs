...
{
    public class IcePunch : DamageMove
    {
        public override string MoveName => "Ice Punch";
        public override string MoveDescription => "The target is punched with an icy fist. This may also leave the target frozen.";
