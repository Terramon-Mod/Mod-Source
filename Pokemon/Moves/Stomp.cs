...
{
    public class Stomp : DamageMove
    {
        public override string MoveName => "Stomp";
        public override string MoveDescription => "The target is stomped with a big foot. This may also make the target flinch.";
