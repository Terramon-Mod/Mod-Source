...
{
    public class Rage : DamageMove
    {
        public override string MoveName => "Rage";
        public override string MoveDescription => "As long as this move is in use, the power of rage raises the Attack stat each time the user is hit in battle.";
