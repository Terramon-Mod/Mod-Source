...
{
    public class Toxic : DamageMove
    {
        public override string MoveName => "Toxic";
        public override string MoveDescription => "A move that leaves the target badly poisoned. Its poison damage worsens every turn.";
