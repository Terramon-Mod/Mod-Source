...
{
    public class LeechSeed : DamageMove
    {
        public override string MoveName => "Leech Seed";
        public override string MoveDescription => "A seed is planted on the target. It steals some HP from the target every turn.";
