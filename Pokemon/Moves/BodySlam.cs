...
{
    public class BodySlam : DamageMove
    {
        public override string MoveName => "Body Slam";
        public override string MoveDescription => "The user drops onto the target with its full body weight. This may also leave the target with paralysis.";
