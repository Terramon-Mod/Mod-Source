...
{
    public class Supersonic : DamageMove
    {
        public override string MoveName => "Supersonic";
        public override string MoveDescription => "The user generates odd sound waves from its body that confuse the target.";
