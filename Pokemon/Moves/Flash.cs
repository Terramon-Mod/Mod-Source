...
{
    public class Flash : DamageMove
    {
        public override string MoveName => "Flash";
        public override string MoveDescription => "The user flashes a bright light that cuts the target’s accuracy.";
