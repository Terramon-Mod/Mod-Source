...
{
    public class EggBomb : DamageMove
    {
        public override string MoveName => "Egg Bomb";
        public override string MoveDescription => "A large egg is hurled at the target with maximum force to inflict damage.";
