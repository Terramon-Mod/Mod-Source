...
{
    public class Smokescreen : DamageMove
    {
        public override string MoveName => "Smokescreen";
        public override string MoveDescription => "The user releases an obscuring cloud of smoke or ink. This lowers the target’s accuracy.";
