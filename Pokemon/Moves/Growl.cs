...
{
    public class Growl : DamageMove
    {
        public override string MoveName => "Growl";
        public override string MoveDescription => "The user growls in an endearing way, making opposing Pokémon less wary. This lowers their Attack stat.";
