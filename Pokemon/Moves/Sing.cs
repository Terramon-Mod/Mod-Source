...
{
    public class Sing : DamageMove
    {
        public override string MoveName => "Sing";
        public override string MoveDescription => "A soothing lullaby is sung in a calming voice that puts the target into a deep slumber.";
