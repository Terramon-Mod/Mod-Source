...
{
    public class HornDrill : DamageMove
    {
        public override string MoveName => "Horn Drill";
        public override string MoveDescription => "The user stabs the target with a horn that rotates like a drill. The target faints instantly if this attack hits.";
