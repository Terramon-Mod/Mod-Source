...
{
    public class Recover : DamageMove
    {
        public override string MoveName => "Recover";
        public override string MoveDescription => "Restoring its own cells, the user restores its own HP by half of its max HP.";
