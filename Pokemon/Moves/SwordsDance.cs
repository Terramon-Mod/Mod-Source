...
{
    public class SwordsDance : DamageMove
    {
        public override string MoveName => "Swords Dance";
        public override string MoveDescription => "A frenetic dance to uplift the fighting spirit. This sharply raises the user’s Attack stat.";
