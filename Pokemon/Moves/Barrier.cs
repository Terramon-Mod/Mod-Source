...
{
    public class Barrier : DamageMove
    {
        public override string MoveName => "Barrier";
        public override string MoveDescription => "The user throws up a sturdy wall that sharply raises its Defense stat.";
