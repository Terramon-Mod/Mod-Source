...
{
    public class RollingKick : DamageMove
    {
        public override string MoveName => "Rolling Kick";
        public override string MoveDescription => "The user lashes out with a quick, spinning kick. This may also make the target flinch.";
