...
namespace Terramon.Pokemon.Moves
{
    ...
    {
        public override string MoveName => "Fury Attack";
        public override string MoveDescription => "The target is jabbed repeatedly with a horn or beak two to five times in a row.";
