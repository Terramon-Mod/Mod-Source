...
{
    public class Minimize : DamageMove
    {
        public override string MoveName => "Minimize";
        public override string MoveDescription => "The user compresses its body to make itself look smaller, which sharply raises its evasiveness.";
