...
{
    public class Metronome : DamageMove
    {
        public override string MoveName => "Metronome";
        public override string MoveDescription => "The user waggles a finger and stimulates its brain into randomly using nearly any move.";
