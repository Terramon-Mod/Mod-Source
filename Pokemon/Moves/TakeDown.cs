...
{
    public class TakeDown : DamageMove
    {
        public override string MoveName => "Take Down";
        public override string MoveDescription => "A reckless, full-body charge attack for slamming into the target. This also damages the user a little.";
