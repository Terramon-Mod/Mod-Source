...
{
    public class Withdraw : DamageMove
    {
        public override string MoveName => "Withdraw";
        public override string MoveDescription => "The user withdraws its body into its hard shell, raising its Defense stat.";
        public override int Damage => 0;
        public override int Accuracy => -1;
        public override int MaxPP => 40;
        public override int MaxBoostPP => 64;
        ...
        public override PokemonType MoveType => PokemonType.Water;
