...
namespace Terramon.Pokemon.Moves
{
    ...
    {
        public override string MoveName => "Surf";
        public override string MoveDescription => "The user attacks everything around it by swamping its surroundings with a giant wave.";
