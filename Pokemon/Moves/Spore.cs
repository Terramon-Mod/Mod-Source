...
{
    public class Spore : DamageMove
    {
        public override string MoveName => "Spore";
        public override string MoveDescription => "The user scatters bursts of spores that induce sleep.";
