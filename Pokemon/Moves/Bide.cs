...
{
    public class Bide : DamageMove
    {
        public override string MoveName => "Bide";
        public override string MoveDescription => "The user endures attacks for two turns, then strikes back to cause double the damage taken.";
