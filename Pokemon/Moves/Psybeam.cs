...
{
    public class Psybeam : DamageMove
    {
        public override string MoveName => "Psybeam";
        public override string MoveDescription => "The target is attacked with a peculiar ray. This may also leave the target confused.";
