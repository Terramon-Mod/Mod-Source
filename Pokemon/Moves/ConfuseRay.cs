...
{
    public class ConfuseRay : DamageMove
    {
        public override string MoveName => "Confuse Ray";
        public override string MoveDescription => "The target is exposed to a sinister ray that triggers confusion.";
