...
{
    public class MegaKick : DamageMove
    {
        public override string MoveName => "Mega Kick";
        public override string MoveDescription => "The target is attacked by a kick launched with muscle-packed power.";
