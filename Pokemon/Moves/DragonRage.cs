...
{
    public class DragonRage : DamageMove
    {
        public override string MoveName => "Dragon Rage";
        public override string MoveDescription => "This attack hits the target with a shock wave of pure rage. This attack always inflicts 40 HP damage.";
        ...
        public override PokemonType MoveType => PokemonType.Dragon;
