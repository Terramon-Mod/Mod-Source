...
{
    public class Glare : DamageMove
    {
        public override string MoveName => "Glare";
        public override string MoveDescription => "The user intimidates the target with the pattern on its belly to cause paralysis.";
