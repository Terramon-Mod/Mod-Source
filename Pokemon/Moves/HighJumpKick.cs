...
namespace Terramon.Pokemon.Moves
{
    ...
    {
        public override string MoveName => "High Jump Kick";
        public override string MoveDescription => "The target is attacked with a knee kick from a jump. If it misses, the user is hurt instead.";
