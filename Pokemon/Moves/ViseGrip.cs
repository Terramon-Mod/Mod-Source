...
{
    public class ViseGrip : DamageMove
    {
        public override string MoveName => "Vise Grip";
        public override string MoveDescription => "The target is gripped and squeezed from both sides to inflict damage.";
