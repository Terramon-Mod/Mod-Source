...
{
    public class ThunderWave : DamageMove
    {
        public override string MoveName => "Thunder Wave";
        public override string MoveDescription => "The user launches a weak jolt of electricity that paralyzes the target.";
