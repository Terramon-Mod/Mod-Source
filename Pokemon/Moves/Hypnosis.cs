...
{
    public class Hypnosis : DamageMove
    {
        public override string MoveName => "Hypnosis";
        public override string MoveDescription => "The user employs hypnotic suggestion to make the target fall into a deep sleep.";
