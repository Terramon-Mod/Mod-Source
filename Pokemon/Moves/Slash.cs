...
{
    public class Slash : DamageMove
    {
        public override string MoveName => "Slash";
        public override string MoveDescription => "The target is attacked with a slash of claws or blades. Critical hits land more easily.";
