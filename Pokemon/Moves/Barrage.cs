...
{
    public class Barrage : DamageMove
    {
        public override string MoveName => "Barrage";
        public override string MoveDescription => "Round objects are hurled at the target to strike two to five times in a row.";
