...
{
    public class DoubleKick : DamageMove
    {
        public override string MoveName => "Double Kick";
        public override string MoveDescription => "The target is quickly kicked twice in succession using both feet.";
