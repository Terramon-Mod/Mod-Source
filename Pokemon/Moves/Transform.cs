...
{
    public class Transform : DamageMove
    {
        public override string MoveName => "Transform";
        public override string MoveDescription => "The user transforms into a copy of the target right down to having the same move set.";
