...
{
    public class Bite : DamageMove
    {
        public override string MoveName => "Bite";
        public override string MoveDescription => "The target is bitten with viciously sharp fangs. This may also make the target flinch.";
        ...
        public override PokemonType MoveType => PokemonType.Dark;
