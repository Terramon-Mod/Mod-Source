...
{
    public class Harden : DamageMove
    {
        public override string MoveName => "Harden";
        public override string MoveDescription => "The user stiffens all the muscles in its body to raise its Defense stat.";
