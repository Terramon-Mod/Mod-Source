...
{
    public class Explosion : DamageMove
    {
        public override string MoveName => "Explosion";
        public override string MoveDescription => "The user attacks everything around it by causing a tremendous explosion. The user faints upon using this move.";
