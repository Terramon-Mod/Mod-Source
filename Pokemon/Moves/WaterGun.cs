...
{
    public class WaterGun : DamageMove
    {
        public override string MoveName => "Water Gun";
        public override string MoveDescription => "The target is blasted with a forceful shot of water.";
