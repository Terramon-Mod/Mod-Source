...
{
    public class Smog : DamageMove
    {
        public override string MoveName => "Smog";
        public override string MoveDescription => "The target is attacked with a discharge of filthy gases. This may also poison the target.";
