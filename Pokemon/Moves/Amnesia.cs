...
{
    public class Amnesia : DamageMove
    {
        public override string MoveName => "Amnesia";
        public override string MoveDescription => "The user temporarily empties its mind to forget its concerns. This sharply raises the user’s Sp. Def stat.";
