...
{
    public class Waterfall : DamageMove
    {
        public override string MoveName => "Waterfall";
        public override string MoveDescription => "The user charges at the target and may make it flinch.";
