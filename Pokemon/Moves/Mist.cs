...
{
    public class Mist : DamageMove
    {
        public override string MoveName => "Mist";
        public override string MoveDescription => "The user cloaks itself and its allies in a white mist that prevents any of their stats from being lowered for five turns.";
        ...
        public override PokemonType MoveType => PokemonType.Ice;
