...
{
    public class DefenseCurl : DamageMove
    {
        public override string MoveName => "Defense Curl";
        public override string MoveDescription => "The user curls up to conceal weak spots and raise its Defense stat.";
