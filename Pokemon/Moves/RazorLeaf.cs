...
namespace Terramon.Pokemon.Moves
{
    ...
    {
        public override string MoveName => "Razor Leaf";
        public override string MoveDescription => "Sharp-edged leaves are launched to slash at the opposing Pokémon. Critical hits land more easily.";
