...
{
    public class Meditate : DamageMove
    {
        public override string MoveName => "Meditate";
        public override string MoveDescription => "The user meditates to awaken the power deep within its body and raise its Attack stat.";
