...
{
    public class Wrap : DamageMove
    {
        public override string MoveName => "Wrap";
        public override string MoveDescription => "A long body, vines, or the like are used to wrap and  squeeze the target for four to five turns.";
