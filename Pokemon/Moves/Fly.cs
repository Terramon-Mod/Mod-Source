...
{
    public class Fly : DamageMove
    {
        public override string MoveName => "Fly";
        public override string MoveDescription => "The user soars and then strikes its target on the next turn.";
