...
{
    public class Blizzard : DamageMove
    {
        public override string MoveName => "Blizzard";
        public override string MoveDescription => "A howling blizzard is summoned to strike opposing Pokémon. This may also leave the opposing Pokémon frozen.";
