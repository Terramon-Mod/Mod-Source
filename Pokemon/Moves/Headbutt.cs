...
{
    public class Headbutt : DamageMove
    {
        public override string MoveName => "Headbutt";
        public override string MoveDescription => "The user sticks out its head and attacks by charging straight into the target. This may also make the target flinch.";
