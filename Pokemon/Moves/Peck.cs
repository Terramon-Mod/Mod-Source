...
{
    public class Peck : DamageMove
    {
        public override string MoveName => "Peck";
        public override string MoveDescription => "The target is jabbed with a sharply pointed beak or horn.";
