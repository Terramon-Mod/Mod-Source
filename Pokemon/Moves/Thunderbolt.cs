...
{
    public class Thunderbolt : DamageMove
    {
        public override string MoveName => "Thunderbolt";
        public override string MoveDescription => "A strong electric blast crashes down on the target. This may also leave the target with paralysis.";
