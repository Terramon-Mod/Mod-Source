...
{
    public class AuroraBeam : DamageMove
    {
        public override string MoveName => "Aurora Beam";
        public override string MoveDescription => "The target is hit with a rainbow-colored beam. This may also lower the target’s Attack stat.";
