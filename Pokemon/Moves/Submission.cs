...
{
    public class Submission : DamageMove
    {
        public override string MoveName => "Submission";
        public override string MoveDescription => "The user grabs the target and recklessly dives for the ground. This also damages the user a little.";
