...
namespace Terramon.Pokemon.Moves
{
    ...
    {
        public override string MoveName => "Wing Attack";
        public override string MoveDescription => "The target is struck with large, imposing wings spread wide to inflict damage.";
