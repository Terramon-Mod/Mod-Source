...
{
    public class StunSpore : DamageMove
    {
        public override string MoveName => "Stun Spore";
        public override string MoveDescription => "The user scatters a cloud of numbing powder that paralyzes the target.";
