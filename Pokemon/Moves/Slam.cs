...
{
    public class Slam : DamageMove
    {
        public override string MoveName => "Slam";
        public override string MoveDescription => "The target is slammed with a long tail, vines, or the like to inflict damage.";
