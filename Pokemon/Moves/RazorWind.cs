...
{
    public class RazorWind : DamageMove
    {
        public override string MoveName => "Razor Wind";
        public override string MoveDescription => "In this two-turn attack, blades of wind hit opposing Pokémon on the second turn. Critical hits land more easily.";
