...
{
    public class Bonemerang : DamageMove
    {
        public override string MoveName => "Bonemerang";
        public override string MoveDescription => "The user throws the bone it holds. The bone loops around to hit the target twice—coming and going.";
