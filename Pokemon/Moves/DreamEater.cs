...
{
    public class DreamEater : DamageMove
    {
        public override string MoveName => "Dream Eater";
        public override string MoveDescription => "The user eats the dreams of a sleeping target. It absorbs half the damage caused to heal its own HP.";
