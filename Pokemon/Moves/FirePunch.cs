...
{
    public class FirePunch : DamageMove
    {
        public override string MoveName => "Fire Punch";
        public override string MoveDescription => "The target is punched with a fiery fist. This may also leave the target with a burn.";
