...
{
    public class PoisonPowder : DamageMove
    {
        public override string MoveName => "Poison Powder";
        public override string MoveDescription => "The user scatters a cloud of poisonous dust that poisons the target.";
