...
{
    public class SoftBoiled : DamageMove
    {
        public override string MoveName => "Soft Boiled";
        public override string MoveDescription => "The user restores its own HP by up to half of its max HP.";
